...
import AddPageForm from "./AddPageAds";
...
const Page = () => {
  ...
  const totalEntries = PageData.length; // Get the total number of entries
  return (
    <Container>
      <div
        style={{
      ...
      >
        <h4 className="mt-3 mb-3">Page Ads List</h4>
        <hr />
        <div>
          <div>
            <Row style={{display:"flex", justifyContent:"flex-end"}}>
              <Col>
              <div>
      <Button className="philosopher-font" style={{ backgroundColor: "#022135", color: "white", display:"flex",alignItems:"center" }} onClick={showModal}>
        Add Page Ads
      </Button>
      <Modal
        title=""
