  ...
  return (
    <div style={{ padding: "1%" }}>
      ...
      {releaseStatus.includes('satelliteRights') && (
        <>
          <Form.Item
            label={<span className="philosopher-font">Satellite Rights</span>}
            name="satelliteRights"
            rules={[
              {
                required: true,
                message: <span className="philosopher-font">Please select Satellite rights</span>,
              },
            ]}
          >
            <Select
          ...
          <Form.Item
            label={<span className="philosopher-font">Satellite Links</span>}
            name="satelliteLinks"
            rules={[
              {
                required: true,
                message: (
                  <span className="philosopher-font">
                    Please enter link for each selected satellite channel
                  </span>
                ),
              },
            ]}
                            ...
                            <Col span={6}>
                              ...
                              >
                                ...
                                >
                                  ...
                                  {formData.cast[fieldKey]?.castDesignation ===
                                    'Actor' && (
                                    <>
                                      <Option
                                        className="philosopher-font"
