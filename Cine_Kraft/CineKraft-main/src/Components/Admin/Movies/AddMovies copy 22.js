...
const AddMovieForm = ({ onSubmit }) => {
  ...
  //       audioRights:values.audioRights,
    ...
    const handleSubmit = async () => {
      try {
        const formData = {
          ...
          audioRights: selectedAudioRights, // Assuming selectedAudioRights is defined elsewhere
        ...
        if (response.status >= 200 && response.status < 300) {
          ...
          // Optionally reset form or clear state after successful submission
          resetForm();
        } else {
