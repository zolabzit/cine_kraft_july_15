  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const newMovie = {
        ...
        audioRights: selectedAudioRights, // Include selected audio rights here
        broadcastChannels: selectedSatelliteChannels, // Include selected broadcast channels here
        ottRights: selectedOTTPlatforms, // Include selected OTT platforms here
        broadcastLinks: values.satelliteLinks, // Assuming satelliteLinks are part of form values
        ottLinks: values.links, // Assuming links are part of form values
      ...
      expectedReleaseDate: values.expectedReleaseDate,
      yetToBeReleasedPlatform: values.yetToBeReleasedPlatform,
      dropStatus: values.dropStatus,
      ...
      if (response.status >= 200 && response.status < 300) {
        ...
        message.success('Movie saved successfully!');
        // Reset form or state here (if using Formik or other form library)
        // Example with Formik: resetForm();
      } else {
