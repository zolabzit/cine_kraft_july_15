    ...
    <Row>
      <Col span={24}>
        <Checkbox
          className="philosopher-font"
          style={{ fontSize: "18px" }}
          value="audioRights"  // Checkbox value for "Audio Rights"
        >
          Audio Rights
        </Checkbox>
      </Col>
      <Col span={24}>
        <Checkbox
          className="philosopher-font"
          style={{ fontSize: "18px" }}
          value="satelliteRights"  // Checkbox value for "Satellite Rights"
        >
          Satellite Rights
        </Checkbox>
      </Col>
      <Col span={24}>
        <Checkbox
          className="philosopher-font"
          style={{ fontSize: "18px" }}
          value="ottRights"  // Checkbox value for "OTT Rights"
        >
          OTT Rights
        </Checkbox>
      </Col>
