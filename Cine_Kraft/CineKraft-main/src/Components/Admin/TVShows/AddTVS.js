...
const AddWsForm = ({ onSubmit }) => {
  ...
  const formFields = [
    {
      ...
      component: (
        <Select
          ...
          placeholder={<span className="philosopher-font">Fiction / Non-Fiction</span>}
        >
          <Option className="philosopher-font"
            value="Fiction"
            style={{ fontFamily: "'Philosopher', sans-serif" }}
          >
            Fiction
    ...
    },
 {
    ...
    // },
    {
      ...
      component: <Input className="philosopher-font" placeholder="Old serial name if any" />,
    },
    {
  ...
  return (
    <div style={{ padding: "1%" }}>
      <h2 className="mt-3 mb-3">Add TVShows</h2>
      <hr />
