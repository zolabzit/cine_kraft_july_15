...
const AddMovieForm = ({ onSubmit }) => {
  ...
  const [formData, setFormData] = useState({
    cast: [
      { castDesignation: "", castName: "", castRole: "", castCharacterName: "", castRemarks: "" },
    ],
    crew: [{ department: "", crewDesignation: "", crewName: "", crewRemarks: "" }],
  });
  ...
  const formFields = [
    ...
    },
    {
      ...
      component: <Input className="philosopher-font" placeholder="Old movie name if any" />,
    },
    {
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      {/* Render options based on designation */}
                                      {formData.cast[fieldKey]?.crewDesignation ===
                                        "Director" && (
                                        <>
                                          <Option
                                            className="philosopher-font"
