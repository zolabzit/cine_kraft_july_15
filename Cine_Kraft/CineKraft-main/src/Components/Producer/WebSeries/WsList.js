...
const MovieData = [
  ...
  const columns = [
    ...
    // },
    {
      title: <span className="philosopher-font">Series Name</span>,
    ...
    {
        title: <span className="philosopher-font">Seasons</span>,
        dataIndex: 'Season',
        key: 'Season',
        width: '10%',
  ...
  return (
    <Container>
      ...
      >
        <h4 className="mt-3 mb-3">WebSeries List</h4>
        <hr />
        <div>
          <div>
