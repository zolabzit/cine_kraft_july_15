...
const VendorsData = [
   {
key: "1", name:"Palani", mobile: "6383038921", subCategory: "Photographic Camera Rental", state: "Bangalore", city: "Bangalore"
   },
   {
    key: "2", name:"Tharun", mobile: "8956412356", subCategory: "VR Device Rental", state: "Chennai", city: "Chennai"
       },
       {
        key: "3", name:"Logesh", mobile: "6932148574", subCategory: "Premium Carvan Service", state: "Bangalore", city: "Bangalore"
           },
           {
            key: "4", name:"Berry", mobile: "7569320890", subCategory: "Generator Service", state: "Chennai", city: "Chennai"
               },
  ];
  ...
  const columns = [
    ...
    {
      title: <span className="philosopher-font"> Name</span>,
      dataIndex: 'name',
      key: 'name',
      width: '15%',
    ...
    {
        title: <span className="philosopher-font">State</span>,
        dataIndex: 'state',
        key: 'state',
        width: '10%',
