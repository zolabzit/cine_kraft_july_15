...
const AddSF = ({ onSubmit }) => {
  ...
  const formFields = [
    {
      label: <span className="philosopher-font">ShortFilms Title</span>,
      name: "ShortFilmsName",
      rules: [
        {
          required: true,
          message: (
            <span className="philosopher-font">
              Please enter the ShortFilms name
            </span>
          ),
        },
      ],
      ...
      rules: [
        {
          ...
          message: (
            <span className="philosopher-font">
              Please enter the ShortFilms description
            </span>
          ),
        },
      ],
    ...
    {
      label: <span className="philosopher-font">ShortFilms Speciality</span>,
      name: "ShortFilmsSpeciality",
      rules: [
        {
          required: false,
        },
    ...
    // {
    //   label: <span className="philosopher-font">ShortFilms Certificate</span>,
    //   name: "production",
    //   rules: [
    //     {
    //       required: true,
    //       message: (
    //         <span className="philosopher-font">
    //           Please enter the ShortFilms certificate
    //         </span>
    //       ),
    //     },
    //   ],
    ...
    // },
    {
      ...
      component: <Input className="philosopher-font" placeholder="Old ShortFilms name if any" />,
    },
    {
      ...
      rules: [
        {
          required: true,
          message: (
            <span className="philosopher-font">Please rate the ShortFilms</span>
          ),
        },
      ],
  ...
  return (
    <div style={{ padding: "1%" }}>
      <h2 className="mt-3 mb-3">Add ShortFilms</h2>
      <hr />
